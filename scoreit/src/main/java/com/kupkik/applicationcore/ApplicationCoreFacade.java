...
public class ApplicationCoreFacade
{
     ...
     */
    public CreateBadmintonSingleGameAnswer createBadmintonSingleGame( final Key seasonKey, final List<Key> team1, final List<Key> team2,
            final String result1, final String result2, final Date date, String gameType )
    {
        ...
        {
            return CreateBadmintonSingleGameAnswer.BADMINTON_SINGLE_RESULTS_INVALID;
            // In case one of both results is >= MIN_END_RESULT - abs of
            // difference of both results must be exactly MAX_WINNING_DISTANCE
        }
        else if( (parsedResultOne > MIN_END_RESULT || parsedResultTwo > MIN_END_RESULT)
                && !(Math.abs(parsedResultOne - parsedResultTwo) == MAX_WINNING_DISTANCE) )
        {
            return CreateBadmintonSingleGameAnswer.BADMINTON_SINGLE_RESULTS_INVALID;
        }
     ...
     */
    public CreateGameAnswer createBadmintonDoubleGame( final Key seasonKey, final List<Key> team1, final List<Key> team2,
            final String resultOne, final String resultTwo, final Date date, String gameType )
    {
    ...
    public CreateSeasonAnswer createSeason( final String pSeasonName, final String pUserName, final String pUserPasswordMd5,
            String gameType, List<String> usersAllowedToEditSeason )
    {
    ...
    public CreateGameAnswer createKickerGame( Key matchDayKey, List<Key> team1, List<Key> team2, String result1, String result2, Date date,
            String gameType )
    {
        if( GameValidator.anyUserSelectedTwice(team1, team2) )
        {
    ...
    public static DisplaySkillGraph getAllKickerGamesInSeason( Key seasonKey, Key userKey )
    {
