...
<%
	if (!StringUtil.isEmptyOrWhitespace((String) request
			.getAttribute(HandlerMessagesEnum.ERROR.toString()))) {
%>
<div class="alert alert-danger"><%=viewHelper.convertTextForHtml((String) request
						.getAttribute(HandlerMessagesEnum.ERROR.toString()))%>
</div>
<%
	} else if (!StringUtil.isEmptyOrWhitespace((String) request
			.getAttribute(HandlerMessagesEnum.SUCCESS.toString()))) {
%>
<div class="alert alert-success"><%=viewHelper.convertTextForHtml((String) request
						.getAttribute(HandlerMessagesEnum.SUCCESS.toString()))%>
</div>
<%
	}
...
<div class="row">
	<div class="col-lg-6">
		...
		<form action="/" method="post">
			...
			<h1>Create Matchday</h1>
			<fieldset>
				<div class="form-group">
					<label>Season</label> <select class="form-control" id="seasonKey"
						name="seasonKey">
						<%
				...
				<div class="form-group">
					<label>Matchday</label> <input class="form-control"
						placeholder="MatchDay Name" name="name" type="text">
				</div>
	...
	<div class="col-lg-6">
		...
		Beschreibung Turnier Beschreibung Turnier Beschreibung Turnier
		Beschreibung Turnier Beschreibung Turnier Beschreibung Turnier
		Beschreibung Turnier Beschreibung Turnier v Beschreibung Turnier
		Beschreibung Turnier Beschreibung Turnier Beschreibung Turnier
		Beschreibung Turnier
