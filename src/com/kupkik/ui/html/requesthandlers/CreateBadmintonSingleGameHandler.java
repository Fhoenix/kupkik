...
public class CreateBadmintonSingleGameHandler  implements IHtmlRequestHandler{
	...
	public String performActionAndGetNextView(HttpServletRequest pRequest,
		...
		String pTournamentName = pRequest.getParameter("tournamentName");
		Date date = new Date();


		CreateGameAnswer createTournamentAnswer = pApplicationCoreFacade.createBadmintonSingleGame(pTournamentName, 
				playerOne, 
				playerTwo, 
				resultOne,
				resultTwo,
